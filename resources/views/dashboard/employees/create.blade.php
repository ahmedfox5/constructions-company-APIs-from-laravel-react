...
@section('content')
    ...
    <form class=" p-2  m-3 border " method="post" action="{{route('store.employee')}}" enctype="multipart/form-data" >

        @csrf

        <div class="border p-3 m-3">
            <label for="tea1">Name</label>
            <input class="w-100 p-2" id="tea1" name="name" placeholder="Name"  >
            <p style="color: #cc0000" >@error('name') {{$message}} @enderror</p>
            <br>
            <label for="tea2">Job</label>
            <input class="w-100 p-2" id="tea2" name="job" placeholder="Job"  >
